...
#ifndef ADDONE_FIRMWARE_VERSION
#define ADDONE_FIRMWARE_VERSION "2.0.0-beta.3"
#endif

constexpr const char* kFirmwareVersion = ADDONE_FIRMWARE_VERSION;
...
constexpr unsigned long kFriendCelebrationMinDissolveMs = 1800;
constexpr unsigned long kFriendCelebrationMaxDissolveMs = 16800;
constexpr unsigned long kFriendCelebrationDwellMs = 15000;
