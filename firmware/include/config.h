...
constexpr uint8_t kFriendCelebrationTransitionRandomOverlap = 10;
// 255 = auto-cycle, 0-10 follow the transition preview library order.
constexpr uint8_t kFriendCelebrationTransitionSelection = kFriendCelebrationTransitionRandomOverlap;
