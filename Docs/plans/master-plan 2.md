...
This compatibility entrypoint exists because the stage-coordinator playbook expects `docs/plans/master-plan.md`.

The canonical master plan for this repo remains:
