# B-007: Stage S3 Onboarding And Wi-Fi Recovery Polish
...
Scope:
- In scope: onboarding UX polish, onboarding validation/error states, onboarding copy/hierarchy, and tightly related Wi-Fi recovery follow-ups.
- Out of scope: friends, profile modeling, broad backend changes, firmware changes, and Expo package audit/alignment.
