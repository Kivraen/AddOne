...
- Future contributor note:
  external designer collaboration now has its own planning checkpoint in [2026-04-05-external-designer-collaboration-plan.md](/Users/viktor/Desktop/DevProjects/Codex/AddOne/Docs/plans/2026-04-05-external-designer-collaboration-plan.md). It should remain a future workflow until `T-056` accepts the baseline freeze, after which the most natural designer slices are `T-057`, `T-059`, and later store-facing work tied to `T-063`.
- Parallel exception:
