...
- Accepted parallel slice: `T-046` is now closed as a narrow UI-only cleanup and does not reopen weekly-minimum semantics, offline-sync work, or broader Friends-controls redesign
