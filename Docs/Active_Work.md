...
| T-022 | Factory station release promotion and broader bench validation | cross-platform | Brief Ready | Unassigned | T-021 | [T-022](tasks/T-022-factory-station-release-promotion-and-bench-validation.md) | — | Strict gate | Use [B-019](briefs/B-019-stage-s2-factory-station-release-promotion-and-bench-validation.md) on `codex/s2-factory-station-promotion` to promote the manifest, run more boards, and tighten retry/rework proof before wider operator use. |
