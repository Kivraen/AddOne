...
- Next brief: [B-013-stage-s3-onboarding-and-recovery-polish.md](briefs/B-013-stage-s3-onboarding-and-recovery-polish.md)
...
| T-008 | Onboarding and Wi-Fi recovery polish batch | app | Brief Ready | Unassigned | T-001 | [T-008](tasks/T-008-onboarding-and-wifi-recovery-polish.md) | — | Strict gate | Start with [B-013](briefs/B-013-stage-s3-onboarding-and-recovery-polish.md) while `T-001` proof is blocked on second-device testing. |
