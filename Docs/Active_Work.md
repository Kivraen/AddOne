...
| T-006 | Timezone model and universal flow audit | cross-platform | In Progress | Hubble | — | [T-006](tasks/T-006-timezone-model-and-universal-flow-audit.md) | — | Strict gate | Review the audit against the stage note, then decide whether timezone is UI-only work or a firmware-backed beta blocker. |
