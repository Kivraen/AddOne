...
- Next brief: [B-016-stage-s3-device-lifecycle-reset-and-first-add-plan.md](briefs/B-016-stage-s3-device-lifecycle-reset-and-first-add-plan.md)
...
| T-019 | Device lifecycle factory reset and first add-flow plan | product | Brief Ready | Unassigned | T-008 | [T-019](tasks/T-019-device-lifecycle-factory-reset-and-first-add-plan.md) | — | Strict gate | Use [B-016](briefs/B-016-stage-s3-device-lifecycle-reset-and-first-add-plan.md) first so the next agent researches the real lifecycle and plans the target flow with the user before implementation. |
